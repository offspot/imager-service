...
if __name__ == "__main__":
    try:
        ...
        if ftp_command_port is None:
            raise FatalError(
                "FTP_COMMAND_PORT needs to be provided as environment variable."
            )
        else:
        ...
        if ftp_data_port_range is None:
            raise FatalError(
                "FTP_DATA_PORT_RANGE needs to be provided as environment variable."
            )
        else:
        ...
        if token_validation_url is None:
            raise FatalError(
                "TOKEN_VALIDATION_URL needs to be provided as environment variable."
            )
        ...
        FTPHandler.banner = "Welcome to the Cardshop Warehouse."
