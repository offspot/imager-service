# Generated by Django 2.1.2 on 2019-01-23 22:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Education Platform for kids",
                        verbose_name="Aflatoun",
                    ),
                ),
                (
                    "content_edupi",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actual_size",
                    models.IntegerField(blank=True, help_text="In bytes (auto calc)"),
                ),
                (
                    "units_coef",
                    models.FloatField(
                        help_text="How much units per GB", verbose_name="Units"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "warehouse",
                    models.CharField(
                        choices=[("kiwix", "kiwix"), ("download", "download")],
                        default="kiwix",
                        max_length=50,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="manager.Profile"
            ),
        ),
        migrations.AddField(
            model_name="order",
